...
(function () {
  var btnGerarCpf = document.querySelector(".btn-gerar-cpf");
  var btnGerarSenha = document.querySelector(".btn-gerar-senha");
  var gerado = document.querySelector(".gerado");
  var btnValidaCpf = document.querySelector(".btn-valida-cpf");
  var inputCpf = document.querySelector(".valida-cpf");
  ...
  btnValidaCpf.addEventListener("click", function () {
    ...
    var cpfValido = new _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_1__["default"](cpf);
